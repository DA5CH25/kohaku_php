...
CREATE TABLE `estado_pago` (
  `id_estado_pagos` int unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
  PRIMARY KEY (`id_estado_pagos`),
  UNIQUE KEY `idestado_pagos_UNIQUE` (`id_estado_pagos`)
...
INSERT INTO `estado_pago` VALUES (1,'Pendiente'),(2,'Cancelado'),(3,'Pago Parcial');
