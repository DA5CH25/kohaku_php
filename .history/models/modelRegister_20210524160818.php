    ...
    class modelRegister extends mainModel{
        ...
        public function add_user_model($datos){
          ...
          $pass= $datos['pass'];
            ...
            $sql=mainModel::connect()->prepare("UPDATE kohaku.usuario SET nombre='$first_name', apellido ='$last_name', numero_identificacion='$numberdoc', telefono_fijo ='$phone', telefono_movil ='$movil']', correo_electonico ='$datos['email']', clave ='$datos['pass']', WHERE id_usuario ='$datos['user_code']'");
