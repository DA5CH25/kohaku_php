        ...
        public function add_user_model($datos){
          ...
          $user_code = $datos['user_code'];
           ...
           $datos['pass'];
            ...
            $sql=mainModel::connect()->prepare("UPDATE kohaku.usuario SET nombre=' $user_code', apellido ='$datos['last_name']', numero_identificacion='$datos['numberdoc']', telefono_fijo ='$datos['phone']', telefono_movil ='$datos['movil']', correo_electonico ='$datos['email']', clave ='$datos['pass']', WHERE id_usuario ='$datos['user_code']'");
