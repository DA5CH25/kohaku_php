    ...
    <nav id="sidebar" class="sidebar-wrapper">
				...
				<div class="sidebar-brand">
					<a href="index.html" class="logo">
						<img src="./vendor/img/logo.png" alt="Le Rouge Admin Dashboard" />
					</a>
				</div>
				<!-- Sidebar brand end  -->
						...
						<ul>
							...
							<li class="sidebar-dropdown active">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="./vendor/index.html" class="current-page">Admin Dashboard</a>
										</li>
										<li>
											<a href="./vendor/sales-dashboard.html">Sales Dashboard</a>
										</li>
										<li>
											<a href="./vendor/crm-dashboard.html">CRM Dashboard</a>
										</li>
										<li>
											<a href="./vendor/ecommerce-dashboard.html">Ecommerce Dashboard</a>
										</li>
									</ul>
								</div>
							</li>
							...
							<li class="sidebar-dropdown">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="./vendor/calendar.html">Daygrid View</a>
										</li>
										<li>
											<a href="./vendor/calendar-external-draggable.html">External Draggable</a>
										</li>
										<li>
											<a href="./vendor/calendar-google.html">Google Calendar</a>
										</li>
										<li>
