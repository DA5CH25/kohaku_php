...
<div class="row gutters">
            ...
            <div class="card-body">
                <div class="account-settings">
                    ...
                    <div class="list-group">
                        <a href="contacts.html" class="list-group-item">Crear otro opcion !!!</a>
    ...
    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
        <div class="card h-100">
            ...
            <div class="card-body">
									<h1 class="styled">Le Rouge Admin template</h1>
									<h2 class="styled">Le Rouge Admin template</h2>
									<h3 class="styled">Le Rouge Admin template</h3>
								</div>
                    ...
                    <div class="list-group">
                        ...
                        <a href="/Kohaku_php/?page=bitacora" class="alert alert-info alert-dismissible fade show">Tienes nuevas anotaciones en la bitacora</a>-->
                            <div class="alert alert-secondary" role="alert">
								<i class="icon-new_releases"></i>Tienes clases pendientes <a href="contacts.html" class="alert-link">Ingresa</a>.
							</div>
                            <div class="alert alert-secondary" role="alert">
								<i class="icon-new_releases"></i>Hay informacion pendiente por ser cargada <a href="/Kohaku_php/?page=class" class="alert-link">Ingresa</a>.
							</div>
                            <div class="alert alert-secondary" role="alert">
								<i class="icon-new_releases"></i>Tienes nuevas registros en la bitacora<a href="/Kohaku_php/?page=bitacora" class="alert-link">Ingresa</a>.
							</div>  
